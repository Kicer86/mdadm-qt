...
#ifndef MDADMDEBUGLAYER_HPP
#define MDADMDEBUGLAYER_HPP
...
class MDAdmDebugLayer : public IMDAdmProcess
{
    public:
        ...
        MDAdmDebugLayer(const MDAdmDebugLayer &);
        MDAdmDebugLayer(MDAdmDebugLayer &&);
        virtual ~MDAdmDebugLayer();

        MDAdmDebugLayer& operator=(const MDAdmDebugLayer &);
        MDAdmDebugLayer& operator=(MDAdmDebugLayer &&);
